...
A lightweight ffi binding of the [cairo graphics] library with the following
features:
  ...
  * the included binary is built with support for in-memory surfaces,
  recording surfaces, ps surfaces, pdf surfaces, svg surfaces, win32 surfaces, win32 fonts and freetype fonts.
